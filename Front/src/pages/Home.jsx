          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {user
              ? `خوش آمدی ${user.username} 👋
               , دنیای فیلم‌ها منتظرته  `
              : "به MovieRating خوش آمدید , دنیای فیلم‌ها منتظرته 🎬"}
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mt-8">
            به بهترین فیلم‌ها و سریال‌ها را امتیاز دهید
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <>
            ...
            {topProducts.length > 0 && (
              <div className="mb-14">
                <h3 className="text-2xl font-bold text-[#1A2A4A] mb-6">
                  🏆 محصولات برتر
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {topProducts.map((product) => (
                    ...
                    >
                      <h4 className="font-bold text-[#1A2A4A] text-xl mb-2 truncate">
                        {product.Pname}
                      </h4>
