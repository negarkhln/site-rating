  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        // const ratingsRes = await axios.get('/api/user-ratings/');
        ...
        setRatings([
          {
            id: 1,
            product: { Pname: "Inception" },
            score: 5,
            record_date: "2025-05-15",
          },
          {
            id: 2,
            product: { Pname: "The Dark Knight" },
            score: 5,
            record_date: "2025-05-10",
          },
          {
            id: 3,
            product: { Pname: "Interstellar" },
            score: 4,
            record_date: "2025-05-05",
          },
          {
            id: 4,
            product: { Pname: "Breaking Bad" },
            score: 5,
            record_date: "2025-04-28",
          },
          {
            id: 5,
            product: { Pname: "Stranger Things" },
            score: 4,
    ...
    <div className="min-h-screen bg-[#F5F0E8] font-sans" dir="rtl">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              {profile?.total_ratings_count > 0 && (
                <div className="bg-gradient-to-r from-[#C9A84C]/20 to-transparent rounded-xl p-4 mb-6 text-center">
          ...
          {/* Empty State */}
          {ratings.length === 0 && (
            <div className="bg-white rounded-2xl shadow-xl mt-8 p-8 text-center">
