              ...
              {hasLink ? (
                <>
                  ...
                  <div className="bg-[#F5F0E8] p-4 rounded-xl mb-6">
                    ...
                    <div className="bg-white p-3 rounded-lg border border-gray-200 break-all font-mono text-sm text-[#1A2A4A]">
                      {resetLink}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    <button
                      ...
                      className="bg-[#1A2A4A] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#2C3E50] transition-all duration-300 flex items-center gap-2"
                    >
                      <span>📋</span>
                    ...
                    <a
                      href={resetLink}
                      className="bg-[#C9A84C] text-[#1A2A4A] px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all duration-300 flex items-center gap-2"
                    >
                      <span>🔗</span>
                      باز کردن لینک
                    </a>
                  ...
                  {/* Warning */}
                  <div className="mt-6 p-3 bg-[#F5F0E8] border border-gray-200 rounded-lg text-center">
                    <p className="text-xs text-gray-600">
                      ⚠️ این لینک فقط برای مدت محدودی معتبر است
                    </p>
                  </div>
                </>
              ) : (
