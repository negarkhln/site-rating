...
const ResetConfirm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // بعداً API رو وصل کن
    try {
      // const response = await axios.post(`/api/reset-password/${uidb64}/${token}/`, {
      ...
      if (err.response?.status === 400) {
        setServerError("لینک بازیابی منقضی شده یا نامعتبر است");
      } else {
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-10 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#C9A84C] transition ${
