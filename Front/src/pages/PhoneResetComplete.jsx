        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-8 text-center">
              ...
              {/* دکمه ورود */}
              <Link to="/login">
                <button className="w-full bg-gradient-to-r from-[#1A2A4A] to-[#2C3E50] text-white py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2">
                  <span>🚪</span>
                  ورود به سایت
                </button>
              </Link>
