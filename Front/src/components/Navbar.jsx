        ...
        <div className="flex space-x-4 space-x-reverse">
          ...
          <Link
            ...
            className={`px-3 py-2 flex items-center gap-2 transition ${
              isActive("/contactus") ? activeStyle : normalStyle
            }`}
          >
            <svg
          ...
          <Link
            to="/movies"
            className={`px-3 py-2 flex items-center gap-2 transition ${
              isActive("/movies") ? activeStyle : normalStyle
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          {isLoggedIn ? (
            <>
              ...
              <button
                ...
                className="px-3 py-2 flex items-center gap-2 text-[#d6d6d6] hover:text-[#f58f7c] transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <>
              ...
              <Link
                to="/signup"
                className="px-4 py-2 flex items-center gap-2 bg-[#f58f7c] text-[#2c2b30] rounded hover:bg-[#c9a7b0] transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
